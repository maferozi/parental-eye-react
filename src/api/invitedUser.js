...
export const getAllInvitedUser = (params) => {
    return axiosClient.get(
        `${BASE_URL}/api/invite-user/`,{params}
    ).then(res => res.data);
}
export const getAllParents = (params) => {
    return axiosClient.get(
        `${BASE_URL}/api/invite-user/parent`,{params}
    ).then(res => res.data);
}
export const getAllDrivers = (params) => {
    return axiosClient.get(
        `${BASE_URL}/api/invite-user/driver`,{params}
    ).then(res => res.data);
}
...
export const addInvitedUser = (body) => {
    ...
    return axiosClient.post(
        `${BASE_URL}/api/invite-user/`,body
    ).then(res => res.data);
}

export const updateInvitedUser = (id,body) => {
    return axiosClient.put(
        `${BASE_URL}/api/invite-user/${id}`,body
    ).then(res => res.data);
}

export const deleteInvitedUser = (id) => {
    return axiosClient.delete(
        `${BASE_URL}/api/invite-user/${id}`
    ).then(res => res.data);
}
...
export const toggleStatusById = (id) => {
    return axiosClient.put(
        `${BASE_URL}/api/invite-user/${id}/toggle-status`
    ).then(res => res.data);
}
