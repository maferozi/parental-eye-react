...
function Sidebar({
    ...
    animate="visible">
                    <motion.li variants={item} className="sidebar-item">
                        <NavLink to={'/dashboard'} className={(navData) => (navData.isActive ? "sidebar-link active" : "sidebar-link")} 
                    ...
                    <motion.li variants={item} className="sidebar-item">
                        <NavLink to={'/user-management'} className={(navData) => (navData.isActive ? "sidebar-link active" : "sidebar-link")} 
                    ...
                    <motion.li variants={item} className="sidebar-item">
                        <NavLink to={'/device'} className={(navData) => (navData.isActive ? "sidebar-link active" : "sidebar-link")} 
                    ...
                    <motion.li variants={item} className="sidebar-item">
                        <NavLink to={'/geofence'} className={(navData) => (navData.isActive ? "sidebar-link active" : "sidebar-link")} 
                    ...
                    <motion.li variants={item} className="sidebar-item">
                        <NavLink to={'/notification'} className={(navData) => (navData.isActive ? "sidebar-link active" : "sidebar-link")} 
