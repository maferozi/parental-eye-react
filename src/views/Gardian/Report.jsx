...
// Simulating guardian's child name (can be dynamic)
const children = ["Ali Khan", "Fatima Zahra"];

const Report = () => {
  const sections = [
    {
      title: "User Activity Logs",
      data: userActivity.filter((user) => children.includes(user.name)),
      columns: [
        { key: "id", header: "ID" },
    ...
    },
    {
      ...
      data: deviceUsage.filter((entry) => children.includes(entry.user)),
      columns: [
    ...
    },
    {
      ...
      data: geoFencing.filter((entry) => children.includes(entry.user)),
      columns: [
        { key: "id", header: "ID" },
    ...
    },
    {
      ...
      data: locationHistory
        .filter((entry) => children.includes(entry.user))
        .flatMap((entry) =>
    ...
    },
    {
      ...
      data: notificationLogs.filter((entry) => children.includes(entry.user)),
      columns: [
        { key: "user", header: "User" },
        { key: "time", header: "Time" },
